...
iabbrev ife if(){<CR><CR><Esc>f}a else{<CR><CR><Esc>4k0f(
"while statement abbreve
iabbrev iwhile while(){<CR><CR><Esc>2k0f(
...
iabbrev iswitch switch(){<CR><Esc>ko case : break<Esc>k0f(
...
"to comment visual selected lines
function! VCommentToggle() 
